...
def main():
    ...
    show_sensor_arrows = st.sidebar.checkbox("Show crowd direction", value = True)
    show_sensor_loc = st.sidebar.checkbox("Show Sensor Location", value=True)
    ...
    # Add sensor direction arrows if enabled
    if show_sensor_arrows:
